        ...
        <div className="w-full bg-slate-50 p-6 min-h-screen">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {data.data.length > 0 ? data.data?.map((announcement: any) => (
                        ...
                        <div className="col-span-3 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all hover:shadow-md hover:border-blue-100 p-6 text-center">
                            <p className="text-gray-600 text-sm font-medium">No announcements found</p>
                        </div>
                    )}
                </div>
                {isValidating && (
