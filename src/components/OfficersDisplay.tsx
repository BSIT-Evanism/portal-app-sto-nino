...
function OfficialCard({ name, position }: { name?: string; position: string }) {
    return (
        <div className="bg-white rounded shadow-sm border w-full max-w-xs mx-auto mb-4 flex flex-col items-center font-sans">
            <div className="font-bold text-lg pt-3 pb-1">Name</div>
            <div className="font-semibold text-base pb-2">{name || <span className="italic text-slate-400">-</span>}</div>
            <div className="text-gray-700 pb-3">{position}</div>
...
export default function OfficersDisplay() {
    ...
    // Helper to render councilors in rows of 4
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-b from-gray-100 to-gray-700 p-8">
            {/* Main Officials */}
            <div className="  rounded-lg p-6 mb-8 ">
                <h2 className="text-3xl font-bold text-center mb-8">List of Brgy. Officials</h2>
            ...
            <div className="  rounded-lg p-6 ">
                <h2 className="text-3xl font-bold text-center mb-8">List of SK Officials</h2>
                <div className="flex justify-center gap-8 mb-6">
                    <div className="flex-1 flex justify-center">
